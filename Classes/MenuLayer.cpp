...
{
	CCLayerColor* colorBackground = CCLayerColor::create(ccc4(0, 0, 0, 75));
...
void MenuLayer::createMenu()
{
	...
	CCMenuItemLabel* mainMenu = CCMenuItemLabel::create(CCLabelTTF::create("回主菜单", fontName->getCString(), fontSize), this, menu_selector(MenuLayer::mainMenu));

	CCMenuItemLabel* musicOn = CCMenuItemLabel::create(CCLabelTTF::create("打开音乐", fontName->getCString(), fontSize));
	CCMenuItemLabel* musicOff = CCMenuItemLabel::create(CCLabelTTF::create("关闭音乐", fontName->getCString(), fontSize));
