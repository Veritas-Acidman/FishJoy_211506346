...
void GameMenuLayer::createMenu(void)
{
	...
	//?item
	CCMenuItemSprite* startMenuItem = CCMenuItemSprite::create(startNormalBgSprite,startSelectedBgSprite,this,
	...
	CCMenuItem* sceneMenuItem = CCMenuItemSprite::create(sceneNormalBgSprite,sceneSelectedBgSprite,
		this,menu_selector(GameMenuLayer::menuCallbackStartGame));
