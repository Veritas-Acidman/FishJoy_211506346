...
bool PanelLayer::init()
{
	...
	_goldCounter->setPosition(ccp(100, 1460));

	ScheduleCountDown* countDown = ScheduleCountDown::create(this);

	_scheduleLabel = CCLabelTTF::create("100", "Thonburi", 75);
	_scheduleLabel->setColor(ccc3(0, 255, 255));
	_scheduleLabel->addChild(countDown);
	this->addChild(_scheduleLabel);
	_scheduleLabel->setPosition(ccp(500, 1460));
